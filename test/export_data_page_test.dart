  ...
  group('ExportDataPage', () {
    ...
    testWidgets('displays "Le projet existe" when project exists remotely', (
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: ExportDataPage(project: testProject, httpClient: mockClient),
          ),
        ),
      );
      await tester
    ...
    testWidgets('fails to create project', (WidgetTester tester) async {
      ...
      expect(find.text('Échec de la création du projet: 500'), findsOneWidget);
      expect(
        find.text('Le projet n\'existe PAS dans la base de données distante.'),
        findsOneWidget,
      );
    });
